...
def submit():
    ...
    try:
        ...
        insert_query = f"INSERT INTO your_table_name(protocol_type, service, dst_bytes, flag, src_bytes, urgent, wrong_fragment) VALUES (%s, %s, %s, %s, %s, %s, %s)"
...
def compare():
    try:
        ...
        return render_template('compare.html', matching_rows=matching_rows)
...
def drop_table():
    try:
        ...
        drop_table_query = f'DROP TABLE IF EXISTS your_table_name'
        ...
        # Redirect to the index page after resetting
        return redirect('/')
